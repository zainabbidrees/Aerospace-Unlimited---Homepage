...
window.AU_DATA = (function () {
  ...
  const RESOURCES = [
    { id: "gse", name: "GSE Tooling", note: "Ground support equipment and specialised maintenance tooling." },
    { id: "aircraft", name: "Parts by Aircraft / Helicopter Model", note: "Browse by airframe or rotorcraft platform.", href: "browse-aircraft.html" },
    { id: "pma", name: "Aircraft PMA Supplements", note: "Approved supplement listings by aircraft type." },
    { id: "repair", name: "Aircraft Repair Capabilities", note: "Send a unit for assessment and overhaul." },
    { id: "salvage", name: "Salvaged Aircraft Parts", note: "Traceable teardown inventory for legacy airframes." },
    /* The live site lists "PMA Parts" and "Aircraft PMA Supplements" as two
       separate nav items. Both point at the one PMA section here rather than
       inventing content for a second page — flag for the client to confirm
       whether these are genuinely distinct offerings. */
    { id: "pma", name: "PMA Parts", note: "Parts Manufacturer Approval alternatives to OEM lines." },
  ];

  return { MANUFACTURERS, CATEGORIES, AIRCRAFT, PARTS, TOP_NSN, RESOURCES };
})();
